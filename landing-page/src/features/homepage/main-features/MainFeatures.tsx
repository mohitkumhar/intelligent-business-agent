...
const features = [
  ...
  },
  {
    title: {
      main: "Always On",
      sub: "Your CFO in Your Pocket",
    },
    description:
      "ProfitPilot is the leading multichannel chat builder, allowing you to build your bot once and deploy it anywhere, via custom domains, embedded containers, popups, chat bubbles, or even on WhatsApp. You can also execute your bot using HTTP requests, making it easy to integrate with other services or use it in different programming languages.",
    link: {
      src: "https://docs.profitpilot.io/deploy/web/overview",
      text: "Read docs",
    },
    video: {
      src: deployVideoSrc,
  ...
  {
    title: {
      main: "More Than Just Tracking",
      sub: "Predict and Grow",
    },
    description:
      "Don't just look at past mistakes. Use AI to forecast future cash flow, simulate hiring scenarios, and spot growth opportunities before your competitors do.",
    video: {
