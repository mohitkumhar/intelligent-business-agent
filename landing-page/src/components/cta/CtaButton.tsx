...
export const ctaButtonVariants = cva("", {
  variants: {
    variant: {
      default:
        "relative overflow-hidden text-white bg-linear-to-b border border-[#1e40af] from-[#60a5fa] to-[#2563eb] to-57% shadow-[inset_0_3px_2px_0_rgba(255,255,255,0.25)] active:from-[#1d4ed8] active:to-[#3b82f6] active:from-43% active:to-100% active:shadow-[inset_0_-2px_2px_0_rgba(255,255,255,0.17)] before:bg-transparent hover:before:bg-white/50 before:w-1/4 before:absolute before:-left-[40%] hover:before:left-[120%] before:transition-[left] before:duration-0 hover:before:duration-700 before:blur-md before:-rotate-45 before:aspect-1/2",
      secondary:
